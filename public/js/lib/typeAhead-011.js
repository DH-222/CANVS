...
(function (root, factory) {
        ...
        _.mixin(Menu.prototype, EventEmitter, {
            ...
            bind () {
                ...
                _.each(this.datasets, (dataset) => {
                    dataset.onSync('asyncRequested', that._propagate, that).onSync('asyncCanceled', that._propagate, that).onSync('asyncReceived', that._propagate, that).onSync('rendered', that._onRendered, that)
    ...
    const Typeahead = (function () {
        function Typeahead (o, www) {
            ...
            this._hacks()
            this.menu.bind().onSync('selectableClicked', this._onSelectableClicked, this).onSync('asyncRequested', this._onAsyncRequested, this).onSync('asyncCanceled', this._onAsyncCanceled, this)
            ...
            this.input.bind().onSync('focused', onFocused, this).onSync('blurred', onBlurred, this).onSync('enterKeyed', onEnterKeyed, this)
        ...
        function c (ctx) {
            ...
            return function () {
                ...
                _.each(methods, method => ctx[method](...args))
            }
        }
    }());
    (function () {
