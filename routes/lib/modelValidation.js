...
const userValidate = class {
  ...
  lookUpParams(req, res, next) {
    ...
    this.cleanse = ['role', 'firstName', 'lastName', 'address', 'state', 'city', 'name', 'mid', '_id', 'id', 'modelType', 'zipcode', 'country', 'collectionName'];
    this.escape = ['bio'];
    this.lookUp = {
      email: {
      ...
      password: {
        func: pass => vali.isLength(pass, { min: 6, max: 20 }),
